Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/accurascan/AccuraKYC-MRZ-Hybrid.git", :tag => "2.3.2" }
  spec.preserve_paths = 'AccuraKYC.xcframework'
  spec.vendored_frameworks = 'AccuraKYC.xcframework'
